...
@ApiModel(value = "OrdersQueryReq", description = "订单表查询Req")
public class OrdersQueryReq extends Page<Orders> implements Serializable {
    ...
    @ApiModelProperty(value = "订单号，唯一标识-模糊匹配")
    ...
    private String shippingAddressLike;
